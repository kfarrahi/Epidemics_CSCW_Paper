...
%% IOVERN(2,:)
function [IOVERN] = epidemic(N, ALPHA, K, DELTAT, BETAR, BETAT, GAMMA, TOTSEC)
CUMTIME = 0;

%% generate random contact list K/node
C = K>0; % list of neighbours
%k = zeros(N,K);      % states of neighbours
